...
public class BuiltTypeScriptCodegenClient extends AbstractTypeScriptClientCodegen {
    ...
    public BuiltTypeScriptCodegenClient() {
        super();
        ...
        outputFolder = "generated-code/built-typescript";
        embeddedTemplateDir = templateDir = "built-typescript";
    ...
    public String getHelp() {
        return "Generates a TypeScript client library for use at Built Technologies.";
    }
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile(".eslintrc.js", "", ".eslintrc.js"));
        supportingFiles.add(new SupportingFile("externals.d.mustache", "", "externals.d.ts"));
    ...
    public OperationsMap postProcessOperationsWithModels(OperationsMap objs, List<ModelMap> allModels) {
        ...
        operations.stream()
            .forEach(op -> {
                this.postProcessOperation(op, allModels);
            });
    ...
    // TODO
    private void postProcessOperation(CodegenOperation op, List<ModelMap> allModels) {
        BuiltTypeScriptCodegenOperation builtOp = new BuiltTypeScriptCodegenOperation(op);
